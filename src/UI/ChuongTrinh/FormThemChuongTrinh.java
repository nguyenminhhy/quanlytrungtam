...
public class FormThemChuongTrinh extends javax.swing.JFrame {
    ...
    /*Khu vực của Tân*/
    // biến tự định nghĩa
    static DefaultComboBoxModel static_dfcDsChungChi;
    static ArrayList<dto_ChungChi> static_dsChungChi;

    // HÀM SETUP FORM
    public void setupForm() {

        static_dsChungChi = new ArrayList<dto_ChungChi>();
//        static_dsChungChi = new bus_ChuongTrinh().layDsChungChi();
//        if (static_dsChungChi != null) {
//            for (int i = 0; i < static_dsChungChi.size(); i++) {
//                cbTenCc.addItem(static_dsChungChi.get(i));
//            }
//        }

        static_dfcDsChungChi = new DefaultComboBoxModel();
        static_dfcDsChungChi.addElement(static_dsChungChi); // addAll

        cbTenCc.setModel(static_dfcDsChungChi);
